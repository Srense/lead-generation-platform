...
export default function Navbar() {
    ...
    return (
        <>
            <header className="fixed top-4 w-full z-40 transition-all duration-300 px-margin-mobile md:px-gutter">
                        ...
                        {isAuthenticated ? (
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 px-4 py-1.5 rounded-full text-xs font-semibold text-white transition-all cursor-pointer shadow-sm hover:border-primary/40 group"
                                    title="Open Account Settings & Password"
                                >
                                    <span className="w-2 h-2 rounded-full bg-primary group-hover:scale-125 transition-transform animate-pulse"></span>
                                    <span className="truncate max-w-[120px]">{userProfile?.name || 'Member'}</span>
                                    <span className="material-symbols-outlined text-sm text-on-surface-variant group-hover:text-primary transition-colors">settings</span>
                                </button>
                                <button
                                    onClick={logout}
            ...
            {/* Profile & Password Change Drawer */}
            <UserProfileSidebar
